            ...
            <% if ("A".equals(userRole)) { %>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-6 col-md-3">
                            <a href="MyPage" class="card custom-card action-card p-3 h-100 text-center shadow-sm text-decoration-none">
                                <div class="icon-box bg-info-subtle text-info mx-auto mb-2"><i class="fa-solid fa-user-gear fa-lg"></i></div>
                                <span class="fw-bold text-dark small">내 정보 수정</span>
                            </a>
                        </div>
                    </div>
            ...
            <% } else { %>
                ...
                <div class="col-12">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-6 col-md-3">
                            <a href="MyPage" class="card custom-card p-4 d-flex flex-column align-items-center justify-content-center h-100 shadow-sm text-decoration-none text-center">
                                <div class="icon-box bg-info text-white shadow mb-2"><i class="fa-solid fa-user-gear fa-lg"></i></div>
                                <h6 class="mb-1 fw-bold text-dark">내 정보 수정</h6>
                                <small class="text-muted">연락처·비밀번호</small>
                            </a>
                        </div>
                    </div>
